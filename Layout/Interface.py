...
def Interface():
    ...
    initial_population.insert(0, "20")
    ...
    entry_prob_cruza.insert(0, "0.50")
    ...
    porcentaje_cruza.insert(0, "0.50")
    ...
    def minimizar():
        ...
        AlgoritmoGenetico(minimo, maximo, delta_deseada_value, equation_value, initial_population_value, limit_population_value, entry_prob_cruza_value, individual_mutation_value, gene_mutation_value, iteration, porcentaje_cruza_value, maximizar)
